...
| --- | --- | --- | --- | ---: | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| checkout-payment-timeout-pass | none | runtime,scenario | `true` | 5 | 0 | `true` | n/a | n/a | n/a | 1.376 | 0.0 | 0.0 |
| gitlab-2017-database-outage-reconstructed | none | runtime,scenario | `true` | 5 | 12 | `false` | 1.0 | 1.0 | 1.0 | 1.551 | 2400.0 | 0.0 |
| owasp-securetea-signin-current-static-and-hyperproperty | none | runtime,static | `true` | 3 | 5 | `false` | 1.0 | 1.0 | 1.0 | 1.927 | 1666.666667 | 0.0 |
| otlp-collector-mixed-signals-pass | none | runtime | `true` | 3 | 0 | `true` | n/a | n/a | n/a | 0.618 | 0.0 | 0.0 |
| otlp-collector-coverage-analysis | otlp,collector,diagnostics | import_diagnostics | `true` | 0 | 4 | `true` | 1.0 | 1.0 | 1.0 | 0.033 | 0.0 | 3.0 |
| temporal-logic-properties-fail | none | runtime | `true` | 8 | 5 | `false` | 1.0 | 1.0 | 1.0 | 0.632 | 625.0 | 0.0 |
| benchmark-missing-correlation | correlation,diagnosability,runtime | runtime | `true` | 3 | 2 | `false` | 1.0 | 1.0 | 1.0 | 0.581 | 666.666667 | 0.0 |
| benchmark-cardinality-budget | cardinality,operability,runtime | runtime | `true` | 2 | 1 | `true` | 1.0 | 1.0 | 1.0 | 0.515 | 500.0 | 0.0 |
| benchmark-privacy-static-source | privacy,security,static,runtime | runtime,static | `true` | 1 | 5 | `false` | 1.0 | 1.0 | 1.0 | 1.479 | 5000.0 | 0.0 |
| benchmark-partial-otlp-diagnostics | otlp,import,diagnostics | import_diagnostics | `true` | 0 | 1 | `true` | 1.0 | 1.0 | 1.0 | 0.014 | 0.0 | 0.333333 |
