...
| --- | --- | --- | ---: | ---: | --- | ---: | ---: | ---: |
| checkout-payment-timeout-pass | runtime,scenario | `true` | 5 | 0 | `true` | n/a | n/a | 1.471 |
| gitlab-2017-database-outage-reconstructed | runtime,scenario | `true` | 5 | 12 | `false` | 1.0 | 1.0 | 1.368 |
| owasp-securetea-signin-current-static | static | `true` | 0 | 2 | `false` | 1.0 | 1.0 | 1.066 |
