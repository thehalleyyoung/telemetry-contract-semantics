...
TAXONOMY: dict[str, dict[str, Any]] = {
    ...
    "static.missing_error_status": _entry("diagnosability", "Set the OpenTelemetry span status to ERROR on error paths.", "STATIC.error-status", "warning"),
    "static.missing_remediation_field": _entry("diagnosability", "Attach a bounded remediation hint on error spans or logs when the contract requires operator guidance.", "STATIC.remediation-evidence", "warning"),
    "static.inconsistent_retryability": _entry("diagnosability", "Attach a bounded retryable value when the contract requires retry guidance.", "STATIC.retryability-evidence", "warning"),
    "static.missing_tracer_name": _entry("static-coverage", "Initialize the OpenTelemetry tracer with the expected instrumentation scope name.", "STATIC.tracer-name", "warning"),
    "static.missing_meter_name": _entry("static-coverage", "Initialize the OpenTelemetry meter with the expected instrumentation scope name.", "STATIC.meter-name", "warning"),
    "static.metric_unit": _entry("schema", "Declare the metric unit in the OpenTelemetry metric API call.", "STATIC.metric-unit", "warning"),
    "static.metric_description": _entry("diagnosability", "Declare the metric description in the OpenTelemetry metric API call.", "STATIC.metric-description", "warning"),
    "static.missing_semconv_attribute": _entry("schema", "Attach the required semantic-convention attribute in source instrumentation.", "STATIC.semconv-attribute", "warning"),
