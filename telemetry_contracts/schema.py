...
CONTRACT_SCHEMA: dict[str, Any] = {
    ...
    "$defs": {
        ...
        "temporalProperty": {
            ...
            "properties": {
                "id": {"type": "string"},
                "type": {"enum": ["safety", "bounded_response", "absence", "ordering", "deadline"]},
                "description": {"type": "string"},
                "required": {"type": "boolean"},
                "group_by": {"type": "array", "items": {"type": "string"}},
                "match": {"$ref": "#/$defs/temporalSelector"},
                "condition": {"$ref": "#/$defs/temporalPredicate"},
                "forbidden": {"$ref": "#/$defs/temporalSelector"},
                "trigger": {"$ref": "#/$defs/temporalSelector"},
                "response": {"$ref": "#/$defs/temporalSelector"},
                "before": {"$ref": "#/$defs/temporalSelector"},
                "after": {"$ref": "#/$defs/temporalSelector"},
        ...
        "assumeGuarantee": {
            "type": "object",
            "properties": {
                "service_guarantees": {"type": "array", "items": {"$ref": "#/$defs/assumeGuaranteeObligation"}},
                "collector_assumptions": {"type": "array", "items": {"$ref": "#/$defs/assumeGuaranteeObligation"}},
                "environment_assumptions": {"type": "array", "items": {"$ref": "#/$defs/assumeGuaranteeObligation"}},
                "oncall_obligations": {"type": "array", "items": {"$ref": "#/$defs/assumeGuaranteeObligation"}},
            },
        },
        "assumeGuaranteeObligation": {
            "type": "object",
            "required": ["id"],
            "properties": {
                "id": {"type": "string"},
                ...
                "any_of": {"type": "array", "items": {"$ref": "#/$defs/alternativeOption"}},
                "no_undocumented_transformations": {"type": "boolean"},
                "approved_transformations": {"type": "array", "items": {"type": "string"}},
                "owner": {"type": "string"},
            },
        },
